...
object HelloWorld:
  ...
  /** More generally you will want to decouple your edge representations from your internal data structures, however this shows how you can create encoders for
    * your data.
    */
