  ...
  def new{{serializer}}{{exportedType.name}}HelidonRoutes(impl: {{exportedTypeFull}}, processor: ResponseProcessor = ResponseProcessor.Default): {{exportedType.name}}HelidonRoutes =
